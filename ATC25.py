...
class TestExpenseComponent(unittest.TestCase):
    ...
    def test_add_expense_with_existing_label(self):
        ...
        wait_and_click(self.driver, 20, 'new UiSelector().text("Last 6 MTHs")')
        time.sleep(2)  # 等待 P&L Statement 頁面載入
    ...
    # def test_add_expense_with_custom_label(self):
    #     """測試使用自定義標籤新增 expense"""
    #     # 處理初始設定和通知提醒
    #     self._handle_initial_setup()

    #     # 使用組件新增 expense: $15 - Coffee (自定義標籤)
    #     print("=== 測試 2: 使用自定義標籤新增 expense ===")
    #     success = add_expense_component(self.driver, "15", "Coffee")
    #     self.assertTrue(success, "新增自定義標籤 expense 失敗")
        
    #     # 驗證是否成功新增 (可能會使用預設標籤)
    #     time.sleep(2)
    #     print("檢查是否成功新增了 expense 記錄...")
    ...
    #     print("=== 測試 3: 新增多筆 expense ===")
        
    #     # 新增第一筆 expense
    #     print("新增第一筆: $20 - Snacks")
    #     success1 = add_expense_component(self.driver, "20", "Snacks")
    #     self.assertTrue(success1, "新增第一筆 expense 失敗")
        
    #     # 新增第二筆 expense
    #     print("新增第二筆: $5 - Drinks")
    #     success2 = add_expense_component(self.driver, "5", "Drinks")
    #     self.assertTrue(success2, "新增第二筆 expense 失敗")
        
    #     # 驗證兩筆記錄
    #     verified1 = verify_expense_added(self.driver, "20", "Snacks")
    #     verified2 = verify_expense_added(self.driver, "5", "Drinks")
        
    #     self.assertTrue(verified1, "驗證第一筆 expense 失敗")
    #     self.assertTrue(verified2, "驗證第二筆 expense 失敗")
        
    #     print("多筆 expense 新增測試完成")

    # def test_add_expense_with_decimal(self):
    #     """測試新增帶小數點的 expense"""
    #     # 處理初始設定和通知提醒
    #     self._handle_initial_setup()

    #     print("=== 測試 4: 新增帶小數點的 expense ===")
        
    #     # 新增帶小數點的 expense: $12.50 - Medical
    #     success = add_expense_component(self.driver, "12.50", "Medical")
    #     self.assertTrue(success, "新增帶小數點的 expense 失敗")
        
    #     print("小數點 expense 新增測試完成")
